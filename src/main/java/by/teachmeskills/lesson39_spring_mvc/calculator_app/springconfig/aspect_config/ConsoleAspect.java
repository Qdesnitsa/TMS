...
public class ConsoleAspect {
    @Before("by.teachmeskills.lesson39_spring_mvc.calculator_app.springconfig.aspect_config.MyPointcut.parseMethods()")
    ...
    @After("by.teachmeskills.lesson39_spring_mvc.calculator_app.springconfig.aspect_config.MyPointcut.parseMethods()")
